section .bss
    array resd 5                 ; Reserve 5 bytes for the array to accept only 5 numbers
...
section .data
    ...
    newline db 10, 0
    output_msg db 10, "The reversed array is: ", 0
    space db " ", 0            ; Space character for output
...
convert_to_ascii:
    ...
    mov eax, 4                 ; sys_write
    mov ebx, 1                 ; stdout
    mov ecx, output_msg        ; Address of the message
